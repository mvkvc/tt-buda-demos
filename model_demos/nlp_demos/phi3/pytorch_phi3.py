...
variants = Literal["mini", "small", "base", "large"]
contexts = Literal["4k", "128k"]

def run_phi3_pybuda_pipeline(_variant: variants="mini", _context: contexts="4k"):
